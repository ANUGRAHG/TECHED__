sap.ui.define([
		...
		return BaseObject.extend("dummy.model.ListSelector", {
			 ...
			 * @class
			 * @public
			 * @alias dummy.model.ListSelector
			 */
			 ...
			 * @return {dummy.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
